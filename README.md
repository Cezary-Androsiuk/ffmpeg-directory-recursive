...
`ffmpeg -i video.mp4 -c:v libx265 -vtag hvc1 -crf 26 -preset medium -c:a copy smaller_size_video.mp4`
...
| **`[command]`** | *(Optional)* The FFmpeg arguments to apply. Use quotes  around the command. <br> **Default:** `"-c:v libx265 -vtag hvc1 -crf 26 -preset medium -c:a copy"` |
...
### Output Files:
<p align="center">
  <img src="https://github.com/Cezary-Androsiuk/FFmpegDirectoryRecursive/blob/master/images/outFiles1.png" width="190" />
  &nbsp;
  <img src="https://github.com/Cezary-Androsiuk/FFmpegDirectoryRecursive/blob/master/images/outFiles2.png" width="290" />
  &nbsp;
  <img src="https://github.com/Cezary-Androsiuk/FFmpegDirectoryRecursive/blob/master/images/outFiles3.png" width="290" />
</p>
